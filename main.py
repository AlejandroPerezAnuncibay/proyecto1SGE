...
def main():
    ...
    def abrirVentanaContrasena():
        ...
        lblNumeros = Label(window, text="¿Quieres que tu contraseña contenga números?")
        lblSimbolos = Label(window, text="¿Quieres que tu contraseña contenga simbolos?")
        lblMayusculas = Label(window, text="¿Quieres que tu contraseña contenga mayusculas?")
        lblMinusculas = Label(window, text="¿Quieres que tu contraseña contenga minusculas?")
